...
void main(List<String> args) {
  CommandRunner('pubspec_lock_merge_driver', 'desc')
...
class MergeCommand extends Command {
  ...
  void run() {
    if (argResults!.rest != 2) {
      stderr.writeln('error: exactly 2 pubspec.lock contents are required to run merge driver');
      exit(1);
    }

    final pubspecContentA = argResults!.rest.first;
    final pubspecContentB = argResults!.rest.last;
...
class InstallCommand extends Command {
  ...
  InstallCommand() {
    argParser
      ..addOption('driverName', defaultsTo: 'pubspec-lock-merge-driver')
      ..addFlag('global', defaultsTo: true);
  }

  @override
  Future<void> run() async {
    await install(
      isGlobal: argResults!['global'] == true,
      driverName: argResults!['driverName'] as String
    );
  }
}
